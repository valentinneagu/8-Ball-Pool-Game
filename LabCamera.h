...
namespace Laborator
{
	...
	public:
		...
		{
			glm::vec4 newVector = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(1, 0, 0)) * glm::vec4(forward, 1);
		...
		{
			glm::vec4 newVector = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 0, 1)) * glm::vec4(right, 1);
			right = glm::normalize(glm::vec3(newVector));
